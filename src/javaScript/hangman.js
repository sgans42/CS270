...
function startNewGame() {
    currentWord = words[Math.floor(Math.random() * words.length)][Math.floor(Math.random() * words[Math.floor(Math.random() * words.length)].length)];
